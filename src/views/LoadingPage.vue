<template>
  <div class="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#1B1B1B]">
    ...
    <div v-if="!store.loadError" class="mt-[60px] text-center">
      ...
      <h3 class="text-white font-light text-[11px] -mt-3 opacity-60">Beta Edition</h3>
      <h3 class="text-white font-light text-[11px] -mt-2.5 opacity-60">
